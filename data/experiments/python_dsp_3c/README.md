...
python analysis/load/dsp_aes_load.py --url http://localhost:8089/process --rate 100 --duration 90

# 3. Run DES on the collected trace
python analysis/des/multi_server_des.py --workers 3 \
  --input data/experiments/python_dsp_3c/<trace_file>.csv \
  --mode replay --output des_out.csv --workers 3

# 4. Re-run all DES modes and regenerate summary + CDF
python analysis/orchestration/run_des_all.py --servers python_dsp_mc
python analysis/reporting/plot_all_cdfs.py python_dsp_3c
```
