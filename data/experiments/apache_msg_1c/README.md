...
python analysis/load/apache_load.py --rate 25 --duration 90

# 3. Run DES on the collected trace
python analysis/des/single_server_des.py \
  --input data/experiments/apache_msg_1c/<trace_file>.csv \
  --mode replay --output des_out.csv

# 4. Re-run all DES modes and regenerate summary + CDF
python analysis/orchestration/run_des_all.py --servers apache_msg
python analysis/reporting/plot_all_cdfs.py apache_msg_1c
```
