"""
write_server_readmes.py — Generate README.md for each data/experiments/ subfolder.
...
BASE = os.path.join(ROOT, "data", "experiments")
...
META = {
    "go_1c": {
        ...
        "model": "M/G/1 — `analysis/des/single_server_des.py`",
        "port": 8080, "cores": 1,
        "compose_svc": "app",
        "load_cmd": "python analysis/load/poisson_load_generator.py --url http://localhost:8080/ --rate 50 --duration 90",
    ...
    "apache_msg_1c": {
        ...
        "port": 8082, "cores": 1,
        "compose_svc": "apache",
        "load_cmd": "python analysis/load/apache_load.py --rate 25 --duration 90",
        "des_script": "single_server_des.py",
        "notes": (
    ...
    "apache_dsp_1c": {
        ...
        "load_cmd": "python analysis/load/dsp_aes_load.py --url http://localhost:8083/process --rate 25 --duration 90",
        "des_script": "single_server_des.py",
        "notes": (
    ...
    "node_dsp_1c": {
        ...
        "load_cmd": "python analysis/load/dsp_aes_load.py --url http://localhost:8084/process --rate 200 --duration 90",
        "des_script": "single_server_des.py",
        "notes": (
    ...
    "python_dsp_1c": {
        ...
        "load_cmd": "python analysis/load/dsp_aes_load.py --url http://localhost:8085/process --rate 50 --duration 90",
        "des_script": "single_server_des.py",
        "notes": (
    ...
    "java_dsp_1c": {
        ...
        "model": "M/G/4 — `analysis/des/multi_server_des.py --workers 4`",
        "port": 8086, "cores": 1,
        "compose_svc": "java-dsp",
        "load_cmd": "python analysis/load/dsp_aes_load.py --url http://localhost:8086/process --rate 100 --duration 90",
    ...
    "go_sqlite_1c": {
        ...
        "load_cmd": "python analysis/load/sqlite_load.py --url http://localhost:8087/process --rate 25 --duration 90",
        "des_script": "single_server_des.py",
        "notes": (
    ...
    "node_dsp_3c": {
        ...
        "model": "M/G/3 — `analysis/des/multi_server_des.py --workers 3`",
        "port": 8088, "cores": 3,
        "compose_svc": "node-dsp-mc",
        "load_cmd": "python analysis/load/dsp_aes_load.py --url http://localhost:8088/process --rate 400 --duration 90",
    ...
    "python_dsp_3c": {
        ...
        "load_cmd": "python analysis/load/dsp_aes_load.py --url http://localhost:8089/process --rate 100 --duration 90",
        "des_script": "multi_server_des.py --workers 3",
        "notes": (
    ...
    "java_dsp_3c": {
        ...
        "load_cmd": "python analysis/load/dsp_aes_load.py --url http://localhost:8090/process --rate 200 --duration 90",
        "des_script": "multi_server_des.py --workers 3",
        "notes": (
    ...
    "go_sqlite_3c": {
        ...
        "load_cmd": "python analysis/load/sqlite_load.py --url http://localhost:8091/process --rate 100 --duration 90",
        "des_script": "multi_server_des.py --workers 3",
        "notes": (
...
SERVER_TAGS = {
    "go_1c": "go",
    "apache_msg_1c": "apache_msg",
    "apache_dsp_1c": "apache_dsp",
    "node_dsp_1c": "node_dsp",
    "python_dsp_1c": "python_dsp",
...
for folder_name, meta in META.items():
    ...
    server_tag = SERVER_TAGS.get(folder_name, folder_name)
...
python analysis/des/{meta["des_script"]} \\
  --input data/experiments/{folder_name}/<trace_file>.csv \\
  --mode replay --output des_out.csv{workers_flag}

# 4. Re-run all DES modes and regenerate summary + CDF
python analysis/orchestration/run_des_all.py --servers {server_tag}
python analysis/reporting/plot_all_cdfs.py {folder_name}
```
"""
